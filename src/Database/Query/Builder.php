...
namespace Vnnit\Soft\Database\Query;
...
use Vnnit\Soft\Database\Eloquent\Builder as EloquentBuilder;
use Vnnit\Soft\Database\Grammar;
...
class Builder
{
     ...
     *
     * @var \Vnnit\Soft\Database\Connection\ConnectionInterface
     */
    public $connection;
	 ...
	 *
	 * @var \Vnnit\Soft\Database\Query\Grammars\Grammar
	 */
	protected $grammar;
     ...
     *
     * @param  \Vnnit\Soft\Database\Connection\ConnectionInterface  $connection
     * @return void
     */
     ...
     *
     * @param  \Closure|\Vnnit\Soft\Database\Query\Builder|\Vnnit\Soft\Database\Eloquent\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     ...
     *
     * @param  \Closure|\Vnnit\Soft\Database\Query\Builder|string  $query
     * @param  string  $as
     * @return $this
     *
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \Closure|\Vnnit\Soft\Database\Query\Builder|string  $table
     ...
     *
     * @param  \Vnnit\Soft\Database\Query\Builder  $parentQuery
     * @param  string  $type
     * @param  string  $table
     * @return \Vnnit\Soft\Database\Query\JoinClause
     */
     ...
     *
     * @param  string  $column
     * @param  \Vnnit\Soft\Contracts\Support\Arrayable|array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     */
     ...
     *
     * @param  string|\Vnnit\Soft\Database\Query\Expression  $column
     * @param  array  $values
     * @param  string  $boolean
     * @param  bool  $not
     * @return $this
     ...
     *
     * @param  \Closure|\Vnnit\Soft\Database\Eloquent\Builder|\Vnnit\Soft\Database\Query\Builder|\Vnnit\Soft\Database\Query\Expression|string  $column
     ...
     *
     * @param  \Closure|\Vnnit\Soft\Database\Query\Builder|\Vnnit\Soft\Database\Query\Expression|string|null  $column
     * @param  string  $direction
     * @return $this
     */
     ...
     *
     * @param  \Vnnit\Soft\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return $this
     */
     ...
     * @return \Vnnit\Soft\Support\Collection
     */
     ...
     * @param  int|null  $page
     * @return \Vnnit\Soft\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Vnnit\Soft\Contracts\Pagination\Paginator
     */
     ...
     * @param  \Vnnit\Soft\Pagination\Cursor|string|null  $cursor
     * @return \Vnnit\Soft\Contracts\Pagination\CursorPaginator
     */
     ...
     *
     * @return \Vnnit\Soft\Support\LazyCollection
     */
     ...
     *
     * @param  mixed  $value
     * @return \Vnnit\Soft\Database\Query\Expression
     */
     ...
     *
     * @return \Vnnit\Soft\Database\Connection\ConnectionInterface
     */
